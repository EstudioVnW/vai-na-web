...
const ModelIntro = () => (
    <S.IntroContainer>
        <S.Wrap>
            <S.TitleBox>
                <S.Title>Até 2025, o mercado brasileiro demandará mais de 300 mil novos talentos digitais</S.Title>

                <S.Text>A solução para esse déficit <strong>não é</strong> remanejar as pessoas que já estão empregadas ou investir naquelas que independente de estímulos vão entrar no mercado de trabalho. Mas sim capacitar e requalificar aqueles que estão à margem e inseri-los.</S.Text>
            </S.TitleBox>

            <S.BoxRow>
                <S.TextBox>
                    <S.RowNumber>27 <span>milhões</span></S.RowNumber>
                    <S.RowText>vivendo abaixo da linha da pobreza</S.RowText>
                </S.TextBox>
                <S.TextBox>
                    <S.RowNumber>14 <span>milhões</span></S.RowNumber>
