...
const PrivacyPolicyContent = () => (
  <S.Container>
    <S.Wrapper>
      <h2>
        Política de Privacidade 2022
      </h2>

      <h3>Este site é mantido e operado pelo Vai na Web.</h3>

      <S.InfoBox>
        <S.Text>
          Nós coletamos e utilizamos alguns dados pessoais que pertencem àqueles que utilizam nosso site. Ao fazê-lo, agimos na qualidade de controlador desses dados e estamos sujeitos às disposições da Lei Federal n. 13.709/2018 (Lei Geral de Proteção de Dados Pessoais -
          {' '}
          <strong>LGPD</strong>
          ).
        </S.Text>
      ...
      <S.InfoBox>
        <S.Title>
          2. Dados pessoais fornecidos expressamente pelo usuário
        </S.Title>
      ...
      <S.InfoBox>
        <S.Title>
          2.1 Quando o usuário preenche o formulário de contato.
        </S.Title>
      </S.InfoBox>

      <S.InfoBox>
        <S.Title>
          2.2 Os dados fornecidos por nossos usuários são coletados com as seguintes finalidades:
        </S.Title>
      </S.InfoBox>

      <S.InfoBox>
        <S.Title>
          2.3 Para que os usuários possam receber informações sobre nossas ofertas e serviços.
        </S.Title>
      </S.InfoBox>
      ...
      <S.InfoBox>
        ...
        <S.Text>
          A presente versão desta Política de Privacidade foi atualizada pela última vez em: 01/06/2022.
        </S.Text>
      ...
      <S.InfoBox>
        ...
        <S.Text>
          Telefone: +55 21 98244 8898
        </S.Text>

        <S.Text>
          Endereço postal: Rua Gomes Lopes, 12, Associação Moradores do Morro dos Prazeres, Santa Tereza, Rio de Janeiro - RJ. CEP: 20241-266
        </S.Text>
      </S.InfoBox>
